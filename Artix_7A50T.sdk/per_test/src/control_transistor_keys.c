...
void SetInitialValuesControlTransistorKeys(){
	...
	//	Xil_Out32(XPAR_IP_AXI_INVERTER_0_S00_AXI_BASEADDR + 25*coef, 0x00000000);			// время AckChecker_wrapper_0 (AcknowledgeTimeGroup1 - резерв) - избыточна
		...
		for (int i = 0; i < 16; i++) {
			Xil_Out32(XPAR_IP_AXI_PWM_0_S00_AXI_BASEADDR + i*coef, 0x000FFFFF+i*0x0100000);			// нулевые значения счетчиков для IP_AXI_PWM (регистры 0-15)
		}
		...
		Xil_Out32(XPAR_IP_AXI_PWM_0_S00_AXI_BASEADDR + 20*coef, 0x000000FF);				// обязательно при прямом управлении Маска

		Xil_Out32(XPAR_IP_AXI_PWM_0_S00_AXI_BASEADDR + 21*coef, 0x00000000);
//		Xil_Out32(XPAR_IP_AXI_PWM_0_S00_AXI_BASEADDR + 22*coef, 0x00000001);				// прямое управление ключами (PWMrightControl) - обнуление задания
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
}
