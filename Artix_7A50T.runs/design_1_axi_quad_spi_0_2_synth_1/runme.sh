...
HD_PWD='D:/GITEA/GitHub/ES/Artix_7A50T/Artix_7A50T.runs/design_1_axi_quad_spi_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_quad_spi_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_quad_spi_0_2.tcl
