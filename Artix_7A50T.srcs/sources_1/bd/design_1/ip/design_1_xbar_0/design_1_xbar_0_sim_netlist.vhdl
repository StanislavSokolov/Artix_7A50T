...
architecture STRUCTURE of design_1_xbar_0_axi_crossbar_v2_1_20_addr_arbiter_sasd is
  ...
  attribute SOFT_HLUTNM of \gen_arbiter.m_grant_hot_i[2]_i_6\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \m_atarget_hot[7]_i_3\ : label is "soft_lutpair24";
  ...
  attribute SOFT_HLUTNM of \m_atarget_hot[8]_i_7\ : label is "soft_lutpair24";
  ...
  attribute SOFT_HLUTNM of \m_axi_bready[6]_INST_0\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \m_axi_bready[7]_INST_0\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \m_axi_bready[7]_INST_0_i_2\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \m_axi_wvalid[6]_INST_0\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \m_axi_wvalid[7]_INST_0\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \m_axi_wvalid[7]_INST_0_i_1\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of m_valid_i_i_7 : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \s_axi_wready[1]_INST_0\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \s_axi_wready[2]_INST_0\ : label is "soft_lutpair26";
...
\gen_arbiter.m_amesg_i[32]_i_8\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\m_axi_awvalid[4]_INST_0\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => \^m_valid_i\,
      I2 => \^aa_grant_rnw\,
      I3 => \gen_axilite.s_axi_bvalid_i_reg_0\(4),
      O => m_axi_awvalid(4)
    );
\m_axi_awvalid[5]_INST_0\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => \^m_valid_i\,
      I2 => \^aa_grant_rnw\,
      I3 => \gen_axilite.s_axi_bvalid_i_reg_0\(5),
      O => m_axi_awvalid(5)
    );
\m_axi_awvalid[6]_INST_0\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => \^m_valid_i\,
      I2 => \^aa_grant_rnw\,
      I3 => \gen_axilite.s_axi_bvalid_i_reg_0\(6),
      O => m_axi_awvalid(6)
    );
\m_axi_awvalid[7]_INST_0\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => \^m_valid_i\,
      I2 => \^aa_grant_rnw\,
      I3 => \gen_axilite.s_axi_bvalid_i_reg_0\(7),
      O => m_axi_awvalid(7)
    );
...
\s_axi_wready[0]_INST_0\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => m_ready_d_1(1),
      I1 => aa_grant_hot(0),
      I2 => \s_axi_wready[2]_INST_0_i_1_n_0\,
      O => s_axi_wready(0)
    );
...
\gen_arbiter.m_grant_hot_i[2]_i_7\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => m_axi_arready(1),
      I3 => f_mux_return8,
      I4 => \gen_arbiter.m_grant_hot_i[2]_i_5_0\,
      I5 => \gen_arbiter.m_grant_hot_i[2]_i_5_1\,
      O => \f_mux_return__1\
    );
...
architecture STRUCTURE of design_1_xbar_0_axi_crossbar_v2_1_20_splitter is
  ...
  attribute SOFT_HLUTNM of \s_axi_bvalid[2]_INST_0_i_4\ : label is "soft_lutpair44";
  attribute SOFT_HLUTNM of \s_axi_wready[2]_INST_0_i_5\ : label is "soft_lutpair44";
begin
...
architecture STRUCTURE of \design_1_xbar_0_axi_crossbar_v2_1_20_splitter__parameterized0\ is
  ...
  attribute SOFT_HLUTNM of \m_ready_d[1]_i_8\ : label is "soft_lutpair42";
  attribute SOFT_HLUTNM of \m_ready_d[1]_i_9\ : label is "soft_lutpair42";
begin
...
architecture STRUCTURE of design_1_xbar_0_axi_crossbar_v2_1_20_crossbar_sasd is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \s_axi_bresp[1]_INST_0_i_1\ : label is "soft_lutpair46";
...
addr_arbiter_inst: entity work.design_1_xbar_0_axi_crossbar_v2_1_20_addr_arbiter_sasd
     port map (
      ...
      aresetn_d_reg_1 => addr_arbiter_inst_n_5,
      \f_mux_return__1\ => \f_mux_return__1\,
      \f_mux_return__6\ => \f_mux_return__6\,
      \gen_arbiter.any_grant_reg_0\ => \gen_decerr.decerr_slave_inst_n_4\,
      \gen_arbiter.any_grant_reg_1\ => splitter_aw_n_14,
      ...
      \s_axi_wready[2]_0\ => \gen_decerr.decerr_slave_inst_n_9\,
      \s_axi_wready[2]_1\ => splitter_aw_n_12,
      \s_axi_wready[2]_2\ => splitter_aw_n_3,
      \s_axi_wready[2]_3\ => splitter_aw_n_6,
      s_axi_wready_2_sp_1 => splitter_aw_n_11,
...
\gen_decerr.decerr_slave_inst\: entity work.design_1_xbar_0_axi_crossbar_v2_1_20_decerr_slave
     port map (
      ...
      \f_mux_return__1\ => \f_mux_return__1\,
      \f_mux_return__6\ => \f_mux_return__6\,
      \gen_arbiter.m_grant_hot_i[2]_i_5\ => addr_arbiter_inst_n_90,
      \gen_arbiter.m_grant_hot_i[2]_i_5_0\ => addr_arbiter_inst_n_91,
      \gen_arbiter.m_grant_hot_i[2]_i_5_1\ => addr_arbiter_inst_n_92,
      \gen_axilite.s_axi_awready_i_reg_0\ => addr_arbiter_inst_n_148,
      \gen_axilite.s_axi_bvalid_i_reg_0\ => addr_arbiter_inst_n_147,
      \gen_axilite.s_axi_rvalid_i_reg_0\(0) => m_atarget_hot(8),
      m_atarget_enc(3 downto 0) => m_atarget_enc(3 downto 0),
      ...
      \m_axi_wready[6]\ => \gen_decerr.decerr_slave_inst_n_9\,
      ...
      s_ready_i_reg_3 => addr_arbiter_inst_n_80
    );
...
reg_slice_r: entity work.design_1_xbar_0_axi_register_slice_v2_1_19_axic_register_slice
     port map (
      ...
      m_valid_i_reg_0 => addr_arbiter_inst_n_42,
...
splitter_aw: entity work.design_1_xbar_0_axi_crossbar_v2_1_20_splitter
     port map (
      ...
      \m_axi_wready[7]\ => splitter_aw_n_3,
...
entity design_1_xbar_0_axi_crossbar_v2_1_20_axi_crossbar is
  ...
  attribute C_M_AXI_ADDR_WIDTH of design_1_xbar_0_axi_crossbar_v2_1_20_axi_crossbar : entity is "256'";
  attribute C_M_AXI_BASE_ADDR : string;
  attribute C_M_AXI_BASE_ADDR of design_1_xbar_0_axi_crossbar_v2_1_20_axi_crossbar : entity is "512'";
  attribute C_M_AXI_READ_CONNECTIVITY : string;
  attribute C_M_AXI_READ_CONNECTIVITY of design_1_xbar_0_axi_crossbar_v2_1_20_axi_crossbar : entity is "256'";
  attribute C_M_AXI_READ_ISSUING : string;
  attribute C_M_AXI_READ_ISSUING of design_1_xbar_0_axi_crossbar_v2_1_20_axi_crossbar : entity is "256'";
  attribute C_M_AXI_SECURE : string;
  attribute C_M_AXI_SECURE of design_1_xbar_0_axi_crossbar_v2_1_20_axi_crossbar : entity is "256'";
  attribute C_M_AXI_WRITE_CONNECTIVITY : string;
  attribute C_M_AXI_WRITE_CONNECTIVITY of design_1_xbar_0_axi_crossbar_v2_1_20_axi_crossbar : entity is "256'";
  attribute C_M_AXI_WRITE_ISSUING : string;
  attribute C_M_AXI_WRITE_ISSUING of design_1_xbar_0_axi_crossbar_v2_1_20_axi_crossbar : entity is "256'";
  attribute C_NUM_ADDR_RANGES : integer;
  attribute C_NUM_ADDR_RANGES of design_1_xbar_0_axi_crossbar_v2_1_20_axi_crossbar : entity is 1;
  attribute C_NUM_MASTER_SLOTS : integer;
  attribute C_NUM_MASTER_SLOTS of design_1_xbar_0_axi_crossbar_v2_1_20_axi_crossbar : entity is 8;
  ...
  attribute P_M_AXI_ERR_MODE of design_1_xbar_0_axi_crossbar_v2_1_20_axi_crossbar : entity is "256'";
  attribute P_M_AXI_SUPPORTS_READ : string;
  attribute P_M_AXI_SUPPORTS_READ of design_1_xbar_0_axi_crossbar_v2_1_20_axi_crossbar : entity is "8'b11111111";
  attribute P_M_AXI_SUPPORTS_WRITE : string;
  attribute P_M_AXI_SUPPORTS_WRITE of design_1_xbar_0_axi_crossbar_v2_1_20_axi_crossbar : entity is "8'b11111111";
...
\gen_sasd.crossbar_sasd_0\: entity work.design_1_xbar_0_axi_crossbar_v2_1_20_crossbar_sasd
     port map (
      ...
      Q(15 downto 0) => \^m_axi_awaddr\(239 downto 224),
      aclk => aclk,
      aresetn => aresetn,
...
architecture STRUCTURE of design_1_xbar_0 is
  ...
  attribute C_M_AXI_BASE_ADDR : string;
  attribute C_M_AXI_BASE_ADDR of inst : label is "512'";
  attribute C_M_AXI_READ_CONNECTIVITY : string;
  ...
  attribute C_M_AXI_WRITE_CONNECTIVITY : string;
  attribute C_M_AXI_WRITE_CONNECTIVITY of inst : label is "256'";
  attribute C_M_AXI_WRITE_ISSUING : string;
