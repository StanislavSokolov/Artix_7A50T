...
set_property PACKAGE_PIN T9 [get_ports {gpio_rtl_2_tri_o[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_rtl_2_tri_o[0]}]
set_property PACKAGE_PIN T10 [get_ports {gpio_rtl_2_tri_o[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_rtl_2_tri_o[1]}]
set_property PACKAGE_PIN R5 [get_ports {gpio_rtl_2_tri_o[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_rtl_2_tri_o[2]}]
set_property PACKAGE_PIN T5 [get_ports {gpio_rtl_2_tri_o[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_rtl_2_tri_o[3]}]
set_property PACKAGE_PIN T7 [get_ports {gpio_rtl_2_tri_o[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_rtl_2_tri_o[4]}]
set_property PACKAGE_PIN T8 [get_ports {gpio_rtl_2_tri_o[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_rtl_2_tri_o[5]}]
set_property PACKAGE_PIN P8 [get_ports {gpio_rtl_2_tri_o[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_rtl_2_tri_o[6]}]
set_property PACKAGE_PIN R8 [get_ports {gpio_rtl_2_tri_o[7]}]
...
set_property PACKAGE_PIN H2 [get_ports {gpio_rtl_3_tri_i[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_rtl_3_tri_i[0]}]
set_property PACKAGE_PIN H1 [get_ports {gpio_rtl_3_tri_i[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_rtl_3_tri_i[1]}]
set_property PACKAGE_PIN J3 [get_ports {gpio_rtl_3_tri_i[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_rtl_3_tri_i[2]}]
set_property PACKAGE_PIN H3 [get_ports {gpio_rtl_3_tri_i[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_rtl_3_tri_i[3]}]
set_property PACKAGE_PIN H5 [get_ports {gpio_rtl_3_tri_i[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_rtl_3_tri_i[4]}]
set_property PACKAGE_PIN H4 [get_ports {gpio_rtl_3_tri_i[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_rtl_3_tri_i[5]}]
set_property PACKAGE_PIN J5 [get_ports {gpio_rtl_3_tri_i[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_rtl_3_tri_i[6]}]
set_property PACKAGE_PIN J4 [get_ports {gpio_rtl_3_tri_i[7]}]
