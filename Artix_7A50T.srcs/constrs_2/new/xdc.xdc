...
set_property PACKAGE_PIN L3 [get_ports {gpio_rtl_1_tri_i[0]}]
set_property PACKAGE_PIN L2 [get_ports {gpio_rtl_1_tri_i[1]}]
set_property PACKAGE_PIN K3 [get_ports {gpio_rtl_1_tri_i[2]}]
set_property PACKAGE_PIN K2 [get_ports {gpio_rtl_1_tri_i[3]}]
